https://images.fravega.com/f300/fa53805370e7eed1fc1eb974d668d857.jpg
        ...
        const html = data.map((el) => {
            if (el.urlImg == null || el.urlImg == "") {
                ...
                <tr>
                    ...
                    <td class="px-5">
                        <img src="${"https://images.fravega.com/f300/fa53805370e7eed1fc1eb974d668d857.jpg"}" class="h-auto" style="object-fit: cover; width: 75px;">
                    </td>
                </tr>
                `)
            } else {
