...
app.use(session({
    store: MongoStore.create({ 
        mongoUrl: 'mongodb+srv://gdabenig:Milagros2011@cluster0.o9zelxa.mongodb.net/ecommerce?retryWrites=true&w=majority',
...
app.get('/home', (req,res)=> { 
    let productos = [
        {nombre: 'Samsung S10', precio: 85000, foto: "https://images.fravega.com/f300/fa53805370e7eed1fc1eb974d668d857.jpg.webp"}, 
        {nombre: 'Samsung galaxy S20', precio: 165000, foto: "https://images.samsung.com/my/smartphones/galaxy-s20/images/galaxy-s20-share-image.jpg"}, 
        {nombre: 'Iphone 11', precio: 200000, foto: "https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/iphone11-black-select-2019_GEO_EMEA?wid=834&hei=1000&fmt=jpeg&qlt=95&.v=1567021766023"}
    ]    
