...
// POST - http://localhost:8080/api/productos?nombre=Awp&precio=8000            Agregar producto 
// PUT -  http://localhost:8080/api/productos/2?nombre=Awp&precio=7000          Cambiar producto
...
const server = app.listen(PORT, () => {
    console.log(`Conectado al puerto  http://localhost:${server.address().port}`);
})
